...
'''
**DONE** Get flask and virtual env working 

**DONE** home page to choose letter amnt
**DONE** have them type in their guess and store it in python
**DONE** print a single guess 

**DONE** print all of their guesses so far out 
**DONE** get letters to correct colors
**DONE** make all letters lower case
**DONE** check to see if they won
**DONE** check to see if they lost
**DONE** reset globals if they won OR lost

**DONE** enforce the word length (use reg express')
**DONE** optimize checker  
**DONE** Make for multiple letters (!!! using functions and arb length !!!)
**DONE** have word randomly choosen

**DONE** fix five letter error (not choosing a 5 letter word)
**DONE** show all letters and their color (red, yellow, green, white)
TODO make pretty

*****************************************MAYBE'S************************************************
TODO 1 to 25 letters w/ 1 function for all letter amounts
TODO gaulent mode where you go from 1 to 25 letters and have amount of guesses per letter
'''
